...
# Þirketi terk edecek müþterileri tahmin edebilecek bir makine öðrenmesi modeli geliþtirilmesi beklenmektedir.

# Veri Seti Hikayesi

# Telco müþteri kaybý verileri, üçüncü çeyrekte Kaliforniya'daki 7043 müþteriye ev telefonu ve Ýnternet hizmetleri saðlayan hayali
# bir telekom þirketi hakkýnda bilgi içerir. Hangi müþterilerin hizmetlerinden ayrýldýðýný, kaldýðýný veya hizmete kaydolduðunu
# gösterir.
...
# Adým 1: Numerik ve kategorik deðiþkenleri yakalayýnýz.
...
# Adým 2: Gerekli düzenlemeleri yapýnýz. (Tip hatasý olan deðiþkenler gibi)
...
# Adým 3: Numerik ve kategorik deðiþkenlerin veri içindeki daðýlýmýný gözlemleyiniz.
...
# Adým 4: Kategorik deðiþkenler ile hedef deðiþken incelemesini yapýnýz.
...
# Adým 5: Aykýrý gözlem var mý inceleyiniz.
...
# Adým 6: Eksik gözlem var mý inceleyiniz.
...
# Adým 1: Sýnýflandýrma algoritmalarý ile modeller kurup, accuracy skorlarýný inceleyip. En iyi 4 modeli seçiniz.
...
# Adým 2: Seçtiðiniz modeller ile hiperparametre optimizasyonu gerçekleþtirin ve bulduðunuz hiparparametreler ile modeli
# tekrar kurunuz.
